...
API_ID = int(environ['24324252'])
API_HASH = environ['7f5a95a95508059acc07a7c3e3697081']
BOT_TOKEN = environ['7791060079:AAGuAG39lXUQJl91EMlKhhFUwVbRP4XODp4']
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', 'anandhukj').split()]
...
# MongoDB information
DATABASE_URI = environ.get('INNOVEX', "")
DATABASE_NAME = environ.get('mongodb+srv://Innovex:INNOVEX@12@innovex.nu57s.mongodb.net/?retryWrites=true&w=majority&appName=Innovex', "tgmoviebot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('1002381851296', 0))
